...
uint256 hashGenesisBlock("0x2d06ed1458e87f41ff60c926d1a2f3f1fde683fff75274fbef11204b358278e6");
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x610cd2b074915cfeca54655305f5d9b46761876206093a2df2e0be138ce75fca");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1391785705; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 3262821;

        if (fTestNet)
        {
            block.nTime    = 1391141796;
            block.nNonce   = 1177973;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x5b08c44ee425e0a139a5f4a78b54debd8552bd1b1fd198307e47276b1f35b2c3"));
